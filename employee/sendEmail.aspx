<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="sendEmail.aspx.cs" Inherits="CompanyProject8209web.demo.sendEmail" %>
    ...
    <table border="0">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="btnSendViaCode" runat="server"  Text="Send email via Code" OnClick="btnSendViaCode_Click" Visible="false" />
