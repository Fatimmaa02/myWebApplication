...
/// </summary>
/// 
namespace CompanyProject8209web.App_Code
{
   public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["CompanyProject8209ConStr"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["CompanyProject8209ConStr"].ConnectionString);
        public CRUD()
        {
            //
